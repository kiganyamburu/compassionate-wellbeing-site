  ...
  const blogPosts = [
    {
      ...
      excerpt:
        "Learn to recognize the signs of anxiety and discover effective coping strategies that can help you manage symptoms and improve your quality of life.",
    ...
    },
    {
      ...
      excerpt:
        "Discover how incorporating mindfulness practices into your daily routine can reduce stress, improve focus, and enhance overall well-being.",
      author: "Dr. Sarah Johnson",
      date: "March 10, 2024",
      readTime: "6 min read",
      category: "Wellness",
    ...
    },
    {
      ...
      excerpt:
        "Explore effective communication strategies that can strengthen your relationships and help you navigate conflicts with understanding and empathy.",
      author: "Dr. Sarah Johnson",
      date: "March 5, 2024",
    ...
    },
    {
      ...
      excerpt:
        "Understanding depression and the path to recovery. Learn about treatment options, self-care strategies, and how to build a support system.",
      author: "Dr. Sarah Johnson",
    ...
    },
    {
      ...
      excerpt:
        "Self-care isn't selfish—it's essential. Learn practical self-care strategies that can improve your mental health and overall quality of life.",
      author: "Dr. Sarah Johnson",
    ...
    },
    {
      ...
      excerpt:
        "Understanding trauma and its impact on mental health. Explore evidence-based approaches to trauma recovery and the journey toward healing.",
      author: "Dr. Sarah Johnson",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-in-left">
              Insights, tips, and guidance on mental health, wellness, and
              personal growth from our experienced therapists.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map((category, index) => (
              <Card
                key={index}
                className="border-0 shadow-card hover:shadow-hover transition-all duration-300 hover:scale-105 cursor-pointer"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2">
              <div className="relative h-64 lg:h-auto">
                ...
                <div className="absolute top-4 left-4">
                  <Badge
                    variant="secondary"
                    className="bg-healing-blue text-white"
                  >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogPosts.slice(1).map((post) => (
              <Card
                key={post.id}
                className="border-0 shadow-card hover:shadow-hover transition-all duration-300 hover:scale-105 overflow-hidden"
              >
                <div className="relative">
                  <Image
                    src={post.image}
