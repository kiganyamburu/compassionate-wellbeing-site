                  ...
                  <div className="flex items-center mb-4">
                    ...
                    <div className="flex space-x-1">
                      {[...Array(testimonial.rating)].map((_, i) => (
                        <Star
                          key={i}
                          className="w-4 h-4 fill-current text-healing-blue"
                        />
                      ))}
                    </div>
                  </div>
                  <p className="text-foreground mb-6 italic leading-relaxed">
                    &lsquo;{testimonial.text}&rsquo;
                  </p>
                  <div className="border-t pt-4">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="text-right">
                        <p className="text-sm font-medium text-healing-blue">
                          {testimonial.service}
                        </p>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Hear directly from my clients about their transformative
              experiences
            </p>
          </div>
            ...
            {[
              {
                ...
                thumbnail:
                  "https://images.unsplash.com/photo-1494790108755-2616b332c108?w=400&h=300&fit=crop&crop=face",
              },
              {
                name: "John D.",
              ...
              <Card
                key={index}
                className="border-0 shadow-card hover:shadow-hover transition-all duration-300 overflow-hidden"
              >
                ...
                <CardContent className="p-4">
                  <p className="text-sm text-muted-foreground">
                    Click to watch this inspiring story of transformation and
                    healing.
                  </p>
                </CardContent>
              </Card>
            ...
            {[
              {
                ...
                description:
                  "92% of clients report significant improvement in anxiety and depression symptoms within 12 weeks.",
              },
              {
                icon: Star,
                title: "Relationship Issues",
                description:
                  "85% of couples report improved communication and relationship satisfaction after therapy.",
              },
              {
                icon: Quote,
                title: "Trauma Recovery",
                description:
                  "88% of trauma survivors experience reduced PTSD symptoms and improved quality of life.",
              },
            ].map((story, index) => (
              <Card
                key={index}
                className="border-0 shadow-card hover:shadow-hover transition-all duration-300 text-center"
              >
                <CardContent className="p-6">
      ...
      <section className="py-20 bg-gradient-to-r from-healing-blue to-healing-green text-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl mb-8 text-white/90">
            Join hundreds of clients who have found healing and transformation
            through our professional therapy services.
          </p>
