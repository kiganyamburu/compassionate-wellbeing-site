    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div
          ...
          style={{ backgroundImage: `url("/images/hero-therapy-office.jpg")` }}
        />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              We offer comprehensive mental health services tailored to your
              unique needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Build stronger family bonds and resolve conflicts in a supportive environment.",
                color: "text-primary",
              },
            ].map((service, index) => (
              <Card
              ...
              >
                <CardHeader className="text-center pb-4">
                  <service.icon
                    className={`w-12 h-12 ${service.color} mx-auto mb-4`}
                  />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-6">
                With over 9 years of experience in mental health counseling,
                Anne is dedicated to helping individuals and families find their
              ...
              <ul className="space-y-4 mb-8">
                ...
                <li className="flex items-center space-x-3">
                  ...
                  <span className="text-foreground">
                    Specializes in CBT and Mindfulness
                  </span>
                </li>
                <li className="flex items-center space-x-3">
                  <div className="w-2 h-2 bg-primary rounded-full" />
                  <span className="text-foreground">
                    500+ Successful Treatment Cases
                  </span>
                </li>
              </ul>
              <Button variant="healing" size="lg" asChild>
                <Link href="/about">Learn More About Anne</Link>
              </Button>
            </div>
