        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto animate-slide-in-left">
              ...
              journey toward healing, growth, and well-being.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                description:
                  "Teaches skills for managing emotions and improving relationships.",
              },
              {
                title: "Psychoeducation & Supportive Counseling",
                description:
                  "Provides clients with information about their mental health conditions and teaches coping strategies.",
              },
              {
                title: "Mindfulness-Based Therapy",
                description:
                  "Incorporates meditation and mindfulness practices for present-moment awareness.",
              },
              {
              ...
              },
              {
                ...
                description:
                  "Helps develop psychological flexibility and values-based living.",
              },
            ].map((approach, index) => (
              <Card
                key={index}
                className="border-0 shadow-card hover:shadow-hover transition-all duration-300"
              >
                <CardHeader>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      We do not accept insurance at this time. Payment is due at
                      the time of service.
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      90-minute initial session to assess your needs and develop
                      a treatment plan.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Weekly or bi-weekly sessions tailored to your progress and
                      needs.
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">
                      Regular check-ins to evaluate progress and adjust
                      treatment as needed.
                    </p>
                  </div>
                </div>
