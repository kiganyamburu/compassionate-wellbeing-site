          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-muted-foreground">
                Anne is a licensed Counseling Psychologist with over 9 years of
                experience supporting individuals, couples, families, and teams.
                She offers compassionate, confidential therapy rooted in
                evidence-based practices, tailored to your unique needs. Anne
              ...
              <p className="text-lg text-muted-foreground">
                ...
                Whether you&lsquo;re feeling stuck or ready for change, Anne is
                here to walk with you on your journey.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="space-y-6 text-lg text-muted-foreground">
                ...
                <p>
                  Whether you&lsquo;re dealing with anxiety, depression,
                  relationship challenges, or life transitions, I&lsquo;m here
                  to walk alongside you on your journey toward greater
            ...
            <div>
              <Image
                src={"/images/meditation-garden.jpg"}
